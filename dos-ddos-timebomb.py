...
def help():
    print("""
Dos/DDos Timebomb 
Tools ini di buat untuk kepentingan praktek dan pembelajaran dan pembuat tidak bertanggung jawab jika tools ini untuk kebetuhuhan Kriminal, dan tanggung akibatnya sendiri.
...
Created By : Hafidz Agus Pratama
Selamat menggunakan!!!
""")
...
while True:
    ...
    if str(waktu) == str(mulai):
        try:
            print(">"*6 + " Sedang Melakukan Penyerangan: Target " + str(host) + "<"*6)
